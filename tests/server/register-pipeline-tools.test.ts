...
describe("registerPipelineTool", () => {
  ...
  it.each([
    ...
    ["pipeline_swap_pipeline_group_order", "Swap CodeArts Pipeline group order"],
    ...
    ["pipeline_get_plugin_metrics", "Get CodeArts Pipeline plugin metrics configuration"],
    ["pipeline_create_plugin_draft", "Create a CodeArts Pipeline plugin draft"],
    ["pipeline_update_plugin_draft", "Update a CodeArts Pipeline plugin draft"],
    ["pipeline_publish_plugin_draft", "Publish a CodeArts Pipeline plugin draft"],
    ["pipeline_delete_plugin_draft", "Delete a CodeArts Pipeline plugin draft"],
    ["pipeline_publish_plugin", "Publish a CodeArts Pipeline plugin"],
    ["pipeline_publish_plugin_bind", "Bind CodeArts Pipeline plugin publisher during publish"],
    ["pipeline_update_plugin_base_info", "Update CodeArts Pipeline plugin base information"],
    ["pipeline_upload_plugin_icon", "Upload a CodeArts Pipeline plugin icon"],
    ...
    ["pipeline_get_tenant_popup_status", "Get CodeArts Pipeline tenant popup status"],
    ...
    ["pipeline_get_accept_free_declaration", "Get CodeArts Pipeline accept-free declaration status"],
    ...
    ["pipeline_list_artifact_versions", "List CodeArts Pipeline artifact versions"],
    ["pipeline_query_manifest_versions", "Query CodeArts Pipeline manifest versions"],
    ["pipeline_get_manifest_versions", "Get CodeArts Pipeline manifest versions"],
    ["pipeline_list_plugin_version_numbers", "List CodeArts Pipeline plugin version numbers"],
    ["pipeline_list_templates_v3", "List CodeArts Pipeline V3 templates"],
    ["pipeline_show_template_detail_v3", "Show CodeArts Pipeline V3 template detail"],
    ["pipeline_show_template_task_status", "Show CodeArts Pipeline template task status"],
    ["pipeline_create_template_task_v3", "Create CodeArts Pipeline V3 template task"],
    ["pipeline_batch_show_pipelines_status", "Batch show CodeArts Pipeline V3 status records"],
    ["pipeline_list_pipelines_v3", "List CodeArts Pipeline V3 pipelines"],
    ["pipeline_show_pipeline_status", "Show CodeArts Pipeline V3 pipeline status"],
    ["pipeline_list_pipeline_build_results", "List CodeArts Pipeline V3 build results"],
    ["pipeline_show_pipeline_detail_v3", "Show CodeArts Pipeline V3 pipeline detail"],
    ["pipeline_list_pipeline_build_records", "List CodeArts Pipeline V3 build records"],
    ["pipeline_get_notice_messages", "Get CodeArts Pipeline notice messages"],
    ["pipeline_start_new_pipeline_v3", "Start CodeArts Pipeline V3 pipeline"],
    ["pipeline_stop_pipeline_v3", "Stop CodeArts Pipeline V3 pipeline"],
