...
const toolStatusSummaryMeta: Record<ModuleName, ToolStatusSummaryMeta> = {
  Req: {
    summary: "Expanded Scrum surface with plan work-item management plus status/public-config/cache support",
    conclusion:
