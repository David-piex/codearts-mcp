...
- Product tools implemented: `742`
- Auth/session tools implemented: `2`
- Total MCP tools exposed: `744`
...
| Repo | 149 | `25 Full / 0 Reachable / 0 Unpublished / 6 Code` | `repo_create_repository` remains live-validated with the previous Repo surface. The repository import / remote mirror tools are code-complete and unit-tested, but not yet counted as AK/SK Full. |
