...
- Product tools implemented: `1086`
- Auth/session tools implemented: `2`
- Total MCP tools exposed: `1088`
...
| Check | 89 | `14 Full / 0 Reachable / 0 Unpublished / 5 Code` | Core Check closure remains usable for task/ruleset/metrics/defect workflows; official read routes are live-validated, while dry-run-safe write/trigger tools still need dedicated real-write samples. |
