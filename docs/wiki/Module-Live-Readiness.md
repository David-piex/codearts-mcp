...
| Check | 31 | 27 | 4 | Validated | Full tool-level live loop completed. |
...
| Build | 59 | 50 | 9 | Validated | Core Build job, record, log, parameter, domain metadata, permission, code-tag, report, and resource-spec tools are covered by live or smoke validation. Git-code endpoint reads are implemented and unit-tested, with endpoint-specific live samples optional. |
...
- Product tools implemented: `876`
- Auth/session tools implemented: `2`
- Total MCP tools exposed: `878`
...
| Check | 31 | `8 Full` | Tool-level closure is complete. |
...
| Build | 59 | Expanded metadata read surface with live smoke coverage | The Build surface now includes metadata reads for domain status, permissions, code tags, report repositories/branches, resource specs, and optional Git-code repositories/branches. |
