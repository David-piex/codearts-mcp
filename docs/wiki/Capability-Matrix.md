...
| TestPlan | 283 | 77 | Partial | `get_plan / list_runs / get_case / run_cases` are unpublished in Beijing 4 |
...
| Build | 100 | 46 | Validated | Core Build job, record, log, parameter, domain metadata, permission, code-tag, report, and resource-spec tools have live or smoke coverage; optional Git-code endpoint reads need endpoint-specific samples |
