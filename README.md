...
- `1091` total MCP tools in shared `http` mode
...
| TestPlan | 241 | Partial | `1 Full / 2 Reachable / 4 Unpublished / 0 Code` |
| Deploy | 74 | Partial | Expanded v4 surface with partial live closure; see `docs/wiki/Module-Live-Readiness.md` |
| Build | 95 | Validated | Expanded metadata read surface with live smoke coverage |
