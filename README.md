...
- `878` total MCP tools in shared `http` mode
...
| Build | 59 | Validated | Expanded metadata read surface with live smoke coverage |
| Artifact | 23 | Partial | `5 Full / 0 Reachable / 7 Unpublished / 0 Code` |
