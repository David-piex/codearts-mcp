...
- `1044` total MCP tools in shared `http` mode
...
| Check | 69 | Partial | `8 Full / 0 Reachable / 6 Unpublished / 0 Code` |
...
| Build | 85 | Validated | Expanded metadata read surface with live smoke coverage |
