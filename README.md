...
- `1039` total MCP tools in shared `http` mode
...
| Check | 68 | Partial | `8 Full / 0 Reachable / 6 Unpublished / 0 Code` |
...
| Build | 81 | Validated | Expanded metadata read surface with live smoke coverage |
| Artifact | 37 | Partial | `5 Full / 0 Reachable / 7 Unpublished / 0 Code` |
