...
| --- | --- | --- | --- |
| Req | 42 | Partial | Expanded Scrum surface with status/workflow config reads; see `docs/wiki/Req-Live-Validated.md` for validated paths and remaining live-depth gaps |
