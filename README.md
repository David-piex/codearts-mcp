...
- `462` total MCP tools in shared `http` mode
...
| Repo | 68 | Partial | `25 Full / 0 Reachable / 0 Unpublished / 6 Code` |
| Pipeline | 78 | Partial | `16 Full / 0 Reachable / 0 Unpublished / 51 Code` |
| Check | 9 | Validated | `8 Full` |
| TestPlan | 8 | Partial | `1 Full / 2 Reachable / 4 Unpublished / 0 Code` |
...
| Artifact | 13 | Partial | `5 Full / 0 Reachable / 7 Unpublished / 0 Code` |
