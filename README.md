...
- `1668` total MCP tools in shared `http` mode
...
| Pipeline | 173 | Partial | `16 Full / 4 Reachable / 1 Unpublished / 52 Code` |
| Check | 111 | Partial | `14 Full / 0 Reachable / 0 Unpublished / 5 Code` |
| TestPlan | 360 | Partial | `1 Full / 2 Reachable / 4 Unpublished / 0 Code` |
| Deploy | 88 | Partial | Expanded v4 surface with partial live closure; see `docs/wiki/Module-Live-Readiness.md` |
| Build | 146 | Validated | Expanded metadata read surface with live smoke coverage |
