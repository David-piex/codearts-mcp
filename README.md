...
- `1075` total MCP tools in shared `http` mode
...
| Build | 93 | Validated | Expanded metadata read surface with live smoke coverage |
| Artifact | 46 | Partial | `5 Full / 0 Reachable / 7 Unpublished / 0 Code` |
